        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <!-- <a href="http://192.168.1.18:8080/website/Signup.html" data-toggle="modal">Sign Up</a> -->
                    </li>
                    <li>
                        <!-- <a href="http://192.168.1.18:8080/website/login.html" ng-click="login() data-toggle="modal" data-target=".bs-example-modal-sm">Log In</a> -->
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
...
<div class="row" style="margin-top:100px">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form class="form-horizontal" role="form" action="AdminServ" method="post">
			<fieldset>
        ...
        <div class="col-sm-5 col-lg-offset-4 col-sm-offset-4">  
              <div class="checkbox">
					...
					<div class="col-sm-5 col-lg-offset-4 col-sm-offset-4" style="margin-top: 15px;">
                        <input type="submit" class="btn btn-lg btn- btn-primary btn-block" name="submit" value="Sign In">
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6" style="display: none;">
						<a href="http://192.168.1.18:8080/website/Signup.html" class="btn btn-lg btn-primary btn-block">Register</a>
					</div>

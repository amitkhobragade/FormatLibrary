        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="Myaccount">Upload History</a>
                    </li>
                    <li>
...
<div class="col-sm-8"><h2 style="margin-bottom: 50px;float: right;">Upload file for Conversion </h2></div>
    <div class="col-sm-4">
      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" style="float:right;color: gr">Help!</button>
    </div> 	
...
<form id="Form"  method="post" role="form" action=FileUploadServlet enctype="multipart/form-data">
   ...
   <div class="row form-group col-lg-6 col-md-6 col-xs-6 col-sm-6"> 
		  ...
		  <input type="file" name="uploadFile"   id="" value="Choose"  /> 
		   <br/>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
         <h4 class="modal-title" style="color: green;font-weight: 800;
">Help!</h4> 
      </div>

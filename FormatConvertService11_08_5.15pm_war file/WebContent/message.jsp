...
<body>
     ...
     <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="Myaccount"><font style="color: green;">Upload History</font></a>
                    </li>
                    <li>
      ...
      <!--   <h4>Encoding</h4> -->
      <h2 style="margin-bottom:50px;text-align:center;">Upload History</h2>
    ...
    <%--  <% 
		ArrayList al = (ArrayList) request.getAttribute("allinfo");
		 ...
		 while(it.hasNext ()){
			 UploadedFileInfo upfileinfo =  (UploadedFileInfo)  it.next ();
			 UploadedFiles  upfile=  (UploadedFiles)  it.next ();
	 %>
	              
    <tr>
    <td><input type="checkbox" class="checkthis" /></td>
    <td><%= upfileinfo.getUser_id() %></td>
    <td><%= upfile.getFile_id() %></td>
    <td>https://<%= upfile.getVideo_file_path() %></td>
    <td><%= upfileinfo.getPrimary_file_ext() %></td>
    <td><%= upfile.getFile_size() %></td>
...
<!-- <tr>
   ...
   for (Map.Entry<Integer, UploadedFileInfo> entry : hashMap.entrySet()) {
    ...
    <td><%= UploadedFiles.getVideo_file_path() %></td>
